  ...
  return (
    <section id="experience" className="relative overflow-hidden bg-background py-20 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto mt-14 max-w-5xl md:mt-18">
          ...
          <div className="space-y-8 md:space-y-10">
            {experience.map((item, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="absolute left-4 top-8 hidden h-3 w-3 -translate-x-1/2 rounded-full border-2 border-background md:block"
                    style={{ backgroundColor: style.accent }}
                  />

                  <div
                    className="rounded-2xl border border-border bg-surface/70 p-5 shadow-lg shadow-black/5 md:p-7"
                    style={{
